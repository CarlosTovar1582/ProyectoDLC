  ...
  const ProductDetails =
  {
    categories: [
      ...
      //GRUPO2(4)-Variadores
      {
        ...
        href: '#',
        imageSrc: 'https://i.postimg.cc/bwpYbwCv/Variador-01.webp',
        imageAlt: 'Black fabric shoe bag with zipper around 3 sides, holding pair of white sneakers.',
        details: [
          {            
            id:'1',
            name: 'Variador Sinovo SD90',
            codigo:'Codigo',
            description: ` 
            <p>   
              <br>                 
            ...
            anidado: [
              ...
              },
              {
                ...
                },
                {
                  ...
                  name: 'Caracteristicas',
                  items: [
                    '(1)  Monofasico/Trifasico (220V)',
                    '(2)  Monofasico/Trifasico (220V)',                 
          ...
          {            
            ...
            description: `
                        <p>   
                         ...
                         `,        
            href: '#',
            imageSrc: 'https://i.postimg.cc/j5f8Qt28/Variador-SD200-1.webp',
            imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
            anidado: [
              {
                id:'1',
          ...
          {            
            ...
            description: `
                        <p>   
                         ...
                         `,        
            href: '#',
            imageSrc: 'https://i.postimg.cc/TYcTJXWY/Variador-SD600.webp',
            imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
            anidado: [
              {
                id:'1',
              ...
              },
              {
                id:'2',
                  ...
                  items: [
                    ...
                    '(12)  Variador de 50HP', 
                    '(13)  Variador de 70HP', 
                    '(14)  Variador de 100HP',
                    '(15)  Variador de 120HP',              
                ...
                },
                {
                  ...
                  name: 'Caracteristicas',
                  items: [
                    '(1)  Trifasico/Trifasico (220V)',
                    '(2)  Trifasico/Trifasico (220V)',
                    '(3)  Trifasico/Trifasico (220V)', 
                    '(4)  Trifasico/Trifasico (220V)',
                    '(5)  Trifasico/Trifasico (220V)',
                    '(6)  Trifasico/Trifasico (220V)',
                    '(7)  Trifasico/Trifasico (220V-380V)',
                    '(8)  Trifasico/Trifasico (220V-380V)',
                    '(9)  Trifasico/Trifasico (220V-380V)',
                    '(10)  Trifasico/Trifasico (220V-380V)',
                    '(11)  Trifasico/Trifasico (220V-380V)',
                    '(12)  Trifasico/Trifasico (220V-380V)',
                    '(13)  Trifasico/Trifasico (220V-380V)',
                    '(14)  Trifasico/Trifasico (220V-380V)',
                    '(15)  Trifasico/Trifasico (220V-380V)',
                                    ...
                                    {/* Image gallery */}
                                        ...
                                        <form className="mt-6">
                                          ...
                                          {/*
                                            ...
                                            <a
                                              href="https://api.whatsapp.com/send?phone=970531712"                                              
                                            >
                                              <button
                                              type="button"
                                              className="flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 sm:w-full"
