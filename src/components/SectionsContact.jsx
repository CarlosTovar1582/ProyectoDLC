    ...
    <div className="bg-white py-8 font-normal text-xl ">
      <div className="mx-auto grid max-w-7xl grid-cols-1  lg:grid-cols-2  gap-2  rounded-3xl bg-white    ">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48   rounded-3xl  text-black 
            border-2 border-slate-700 bg-gradient-to-r from-teal-50 via-teal-50 to-teal-50 ">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg ">
            ...
            <p className="mt-6 text-xl leading-8 text-black font-normal  ">
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-300">
              <div className="flex gap-x-4">
                ...
                <dd className='text-black font-normal text-xl'>
                    Av.argentina cdra 523 centro comercial
                    <br /> 
                    ACOPROM Tienda A28,E4 Lima, Peru
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="text-black text-xl" href="tel:+1 (555) 234-5678">
                    +51 (970) 531 712
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="text-black text-xl" href="mailto:hello@example.com">
                    
                    electricdlc2@gmail.com
                  </a>
                </dd>
              </div>
            </dl>
